...
<head>
   <meta charset="utf-8">
   <title>jQuery plus.repeater: Edit Form From Old Datas</title>
...
<body>
      ...
      <table style="border: 1px solid black;width: 98%;">
         ...
         <tbody id="repeaterA">
            <tr id="#id#" class="clone">
               ...
               <td style="text-align: left;"><a class="remove">remove</a></td>
            </tr>
            <?php
            $datas = array();
   ...
   <script src="../build/jQuery-plus-repeater.min.js"></script>
